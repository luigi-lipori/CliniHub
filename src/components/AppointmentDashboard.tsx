...
// Importado Trash2 para o botão de apagar
import { Plus, Search, ChevronLeft, ChevronRight, ChevronDown, Trash2 } from 'lucide-react';
...
export const AppointmentDashboard: React.FC<{ onNewAppointment: () => void }> = ({ onNewAppointment }) => {
  // Extraído removeAppointment do context
                  ...
                  <div key={i} className="border-r border-slate-50 p-1 hover:bg-blue-50/10 transition-colors relative flex flex-col gap-1">
                    {slotAppointments.map((appointment) => (
                      <motion.div 
                        ...
                        // Adicionado "group" para permitir efeitos no hover
